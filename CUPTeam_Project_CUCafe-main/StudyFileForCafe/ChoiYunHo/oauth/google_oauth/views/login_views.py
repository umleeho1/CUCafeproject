...
class GoogleOauthLogin:
    ...
    def google_callback(request):
        ...
        access_token = service_views.GoogleService.google_get_access_token(code) #code를 이용해서 access token을 받아옴 / views_service.py의 class Service 이용
        ...
        user_data = service_views.GoogleService.google_get_user_info(access_token=access_token)
        profile_data = {
